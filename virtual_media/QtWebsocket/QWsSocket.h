...
public:
    ...
    void setSIDfromHTTP(QString s);
    void setWSPath(QString wp);
...
public slots:
    ...
    void connectToWSSHost(const QString & hostName, QSslSocket *sslSocket_from_client , quint16 port = 443, OpenMode mode = ReadWrite);
...
public:
    ...
    QString composeOpeningHandShakeV0(QString resourceName, QString host, QByteArray key1, QByteArray key2, QByteArray key3, QString origin = "", QString protocol = "", QString extensions = "");
    QString composeOpeningHandShakeV13(QString resourceName, QString host, QByteArray key, QString origin = "", QString protocol = "", QString extensions = "");
